...
def getColumn():
    ...
    columnList = ["name","cn","objectclass","objectcategory","adspath","description","memberof","member","samaccounttype","samaccountname","operatingsystem","serviceprincipalname","dnshostname","primarygroupid","dc","ou","distinguishedname"]
    for x in fi:
